...
public class InfoUtils {
  ...
  private static final MessageRenderer IN_GAME_MESSAGES = new MessageRenderer(
    0xA0000000,
    0
  )
   ...
   * @param args
   */
  public static void showGuiMessage(
    MessageType type,
  ...
  public static void showGuiMessage(
    ...
    if (GuiUtils.getCurrentScreen() instanceof IMessageConsumer) {
      ((IMessageConsumer) GuiUtils.getCurrentScreen()).addMessage(
          type,
          lifeTime,
          translationKey,
          args
   ...
   * @param args
   */
  public static void showGuiOrActionBarMessage(
    MessageType type,
    String translationKey,
    Object... args
  ) {
  ...
  public static void showGuiOrActionBarMessage(
    ...
    if (GuiUtils.getCurrentScreen() instanceof IMessageConsumer) {
      ...
      String msg =
        type.getFormatting() +
        StringUtils.translate(translationKey, args) +
        GuiBase.TXT_RST;
   ...
   * @param args
   */
  public static void showGuiOrInGameMessage(
    MessageType type,
    String translationKey,
    Object... args
  ) {
   ...
   * @param args
   */
  public static void showGuiAndInGameMessage(
    MessageType type,
    String translationKey,
    Object... args
  ) {
   ...
   * @param args
   */
  public static void showInGameMessage(
    MessageType type,
    String translationKey,
    Object... args
  ) {
  ...
  public static void printBooleanConfigToggleMessage(
    String prettyName,
    boolean newValue
  ) {
    String pre = newValue ? GuiBase.TXT_GREEN : GuiBase.TXT_RED;
    String status = StringUtils.translate(
      "malilib.message.value." + (newValue ? "on" : "off")
    );
    String message = StringUtils.translate(
      "malilib.message.toggled",
      prettyName,
      pre + status + GuiBase.TXT_RST
    );
