...
public class StringUtils {
  ...
  public static String getModVersionString(String modId) {
    for (net.fabricmc.loader.api.ModContainer container : net.fabricmc.loader.api.FabricLoader
      .getInstance()
      .getAllMods()) {
  ...
  public static void sendOpenFileChatMessage(
    net.minecraft.entity.Entity sender,
    String messageKey,
    File file
  ) {
    net.minecraft.text.Text name = Text
      .literal(file.getName())
   ...
   * @param maxLineLength
   */
  public static void splitTextToLines(
  ...
  public static String getClampedDisplayStringStrlen(
    List<String> list,
    final int maxWidth,
    String prefix,
    String suffix
  ...
  public static String getClampedDisplayStringRenderlen(
    List<String> list,
    final int maxWidth,
    String prefix,
    String suffix
    ...
    if (listSize > 0) {
      for (
        int listIndex = 0;
        listIndex < listSize && width < maxWidth;
        ++listIndex
      ) {
        if (listIndex > 0) {
          sb.append(entrySep);
    ...
    if (mc.isIntegratedServerRunning()) {
      ...
      if (mc.isConnectedToRealms()) {
        if (MaLiLibConfigs.Generic.REALMS_COMMON_CONFIG.getBooleanValue()) {
          ...
          net.minecraft.network.ClientConnection connection = handler != null
  ...
  public static String getStorageFileName(
    ...
    if (name != null) {
      ...
      net.minecraft.world.World world = net.minecraft.client.MinecraftClient.getInstance()
        .world;

      if (world != null) {
        return (
          prefix + name + "_dim_" + WorldUtils.getDimensionId(world) + suffix
        );
      }
    }
  ...
  @Nullable
  public static String getTranslatedOrFallback(
    String key,
  ...
  public static String translate(String translationKey, Object... args) {
    return net.minecraft.client.resource.language.I18n.translate(
      translationKey,
      args
    );
  }
