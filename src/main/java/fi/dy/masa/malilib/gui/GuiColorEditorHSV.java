...
public class GuiColorEditorHSV extends GuiDialogBase {
  ...
  public void initGui() {
    ...
    this.textFieldFullColor =
      new GuiTextFieldGeneric(this.xH, y + 1, 68, 14, this.textRenderer);
    this.textFieldFullColor.setMaxLength(12);
    this.addTextField(
        this.textFieldFullColor,
        new TextFieldListener(null, this)
      );
  ...
  protected int createComponentElements(
    int x,
    int y,
    int xLabel,
    Element element
  ...
  protected void updateColorFromMouseInput(
    Element element,
    int mouseX,
    int mouseY
  ) {
  ...
  public static void renderGradientColorBar(
    int x,
    int y,
    float z,
    int width,
  ...
  public static void renderHueBarHorizontal(
    int x,
    int y,
    float z,
    int width,
  ...
  public static void renderHueBarVertical(
    int x,
    int y,
    float z,
    int width,
  ...
  public static void renderHueBar(
    int x,
    int y,
    float z,
    int width,
  ...
  public static void renderHueBarSegment(
    int x,
    int y,
    float z,
    int width,
    ...
    buffer
      .vertex(x + width, y + height + segmentHeight, z)
      .color(r1, g1, b1, a)
      .next();
    buffer
      .vertex(x + width + segmentWidth, y + height, z)
      .color(r2, g2, b2, a)
      .next();
    buffer.vertex(x + segmentWidth, y, z).color(r2, g2, b2, a).next();
  }

  public static void renderHSSelector(
    int xStart,
    int yStart,
    float z,
    int width,
  ...
  public static void renderBarMarkerHorizontalBar(
    int x,
    int y,
    float z,
    int barWidth,
  ...
  public static void renderBarMarkerVerticalBar(
    int x,
    int y,
    float z,
    int barWidth,
  ...
  protected Element getHoveredElement(int mouseX, int mouseY) {
    if (
      mouseX >= this.xHS &&
      mouseX <= this.xHS + this.sizeHS &&
      mouseY >= this.yHS &&
      mouseY <= this.yHS + this.sizeHS
    ) {
      return Element.SV;
    } else if (
      mouseX >= this.xHFullSV &&
      mouseX <= this.xHFullSV + this.widthHFullSV &&
      mouseY >= this.yHS &&
      mouseY <= this.yHS + this.sizeHS
    ) {
