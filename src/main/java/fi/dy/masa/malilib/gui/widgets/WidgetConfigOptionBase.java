...
public abstract class WidgetConfigOptionBase<TYPE>
  ...
  public boolean hasPendingModifications() {
    if (this.textField != null) {
      return (
        this.textField.getTextField().getText().equals(this.lastAppliedValue) ==
        false
      );
    }
  ...
  protected GuiTextFieldGeneric createTextField(
    int x,
    int y,
    int width,
    int height
  ...
  protected void addTextField(
    ...
    ConfigOptionChangeListenerTextField listener
  ) {
    TextFieldWrapper<? extends GuiTextFieldGeneric> wrapper = new TextFieldWrapper<>(
      field,
      listener
    );
  ...
  protected boolean onMouseClickedImpl(
    ...
    if (this.textField != null) {
      ret |=
        this.textField.getTextField().mouseClicked(mouseX, mouseY, mouseButton);
    }
  ...
  protected boolean onCharTypedImpl(char charIn, int modifiers) {
    if (
      this.textField != null && this.textField.onCharTyped(charIn, modifiers)
    ) {
      return true;
    }
