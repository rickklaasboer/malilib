...
public class WidgetColorIndicator extends WidgetBase {
  ...
  public WidgetColorIndicator(
    ...
    ((ConfigInteger) this.config).setValueChangeCallback(cfg ->
        consumer.accept(cfg.getIntegerValue())
      );
  }
  ...
  public WidgetColorIndicator(
    ...
    this.hoverText =
      ImmutableList.of(
        StringUtils.translate("malilib.hover.color_indicator.open_color_editor")
      );
  }
  ...
  protected boolean onMouseClickedImpl(
    ...
    GuiColorEditorHSV gui = new GuiColorEditorHSV(
      this.config,
      null,
  ...
  public void render(
    ...
    RenderUtils.drawRect(
      ...
      width - 4,
      height - 4,
      0xFF000000 | this.config.getIntegerValue(),
      z
    );
  }
}
