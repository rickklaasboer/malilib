...
public class GuiConfirmAction
  ...
  public GuiConfirmAction(
    ...
    StringUtils.splitTextToLines(
      this.messageLines,
      StringUtils.translate(messageKey, args),
      width - 30
    );
  ...
  public void drawContents(
    ...
    drawContext.getMatrices().translate(0, 0, 1.f);
  ...
  public void addMessage(
    ...
    if (this.getParent() instanceof IMessageConsumer) {
      ((IMessageConsumer) this.getParent()).addMessage(
          type,
          lifeTime,
          messageKey,
          args
  ...
  protected enum ButtonType {
    ...
    public String getDisplayName() {
      return (
        (this == ButtonType.OK ? GuiBase.TXT_GREEN : GuiBase.TXT_RED) +
        StringUtils.translate(this.labelKey) +
        GuiBase.TXT_RST
      );
    }
  }
