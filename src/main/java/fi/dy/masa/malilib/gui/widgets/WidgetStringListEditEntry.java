...
public class WidgetStringListEditEntry extends WidgetConfigOptionBase<String> {
  ...
  public WidgetStringListEditEntry(
    int x,
    int y,
    int width,
    int height,
  ...
  protected ButtonGeneric createResetButton(
    ...
    resetButton.setEnabled(
      textField.getText().equals(this.defaultValue) == false
    );
  ...
  private void insertEntryBefore() {
    ...
    int index = this.listIndex < 0
      ? size
      : (this.listIndex >= size ? size : this.listIndex);
    list.add(index, "");
  ...
  private boolean canBeMoved(boolean down) {
    ...
    return (
      ...
      (
        (down && this.listIndex < (size - 1)) ||
        (down == false && this.listIndex > 0)
      )
    );
  }
  ...
  public static class ChangeListenerTextField
    ...
    public boolean onTextChange(GuiTextFieldGeneric textField) {
      this.buttonReset.setEnabled(
          this.textField.getText().equals(this.defaultValue) == false
        );
      return false;
    }
  }
  ...
  private static class ListenerResetConfig implements IButtonActionListener {
    ...
    public ListenerResetConfig(
      ...
      WidgetStringListEditEntry parent
    ) {
