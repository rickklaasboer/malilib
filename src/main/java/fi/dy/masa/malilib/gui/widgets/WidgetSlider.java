...
public class WidgetSlider extends WidgetBase {
  ...
  public static final Identifier VANILLA_WIDGETS = new Identifier(
  ...
  public WidgetSlider(
    ...
    this.sliderWidth =
      MathHelper.clamp(
        usableWidth / callback.getMaxSteps(),
        8,
        usableWidth / 2
      );
  }
  ...
  public void render(
    ...
    RenderUtils.drawTexturedRect(
      this.x + 2 + (int) (relPos * usableWidth),
      this.y,
      0,
      66,
      s,
    ...
    RenderUtils.drawTexturedRect(
      this.x + 2 + (int) (relPos * usableWidth) + s,
      this.y,
      200 - s,
      66,
      s,
  ...
  protected double getRelativePosition(int mouseX) {
    ...
    return MathHelper.clamp(
      (double) relPos / (double) (this.width - this.sliderWidth - 4),
      0,
      1
    );
  }
