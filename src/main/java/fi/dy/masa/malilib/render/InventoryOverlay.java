...
public class InventoryOverlay {
  ...
  public static final Identifier TEXTURE_BREWING_STAND = new Identifier(
    "textures/gui/container/brewing_stand.png"
  );
  public static final Identifier TEXTURE_DISPENSER = new Identifier(
    "textures/gui/container/dispenser.png"
  );
  public static final Identifier TEXTURE_DOUBLE_CHEST = new Identifier(
    "textures/gui/container/generic_54.png"
  );
  public static final Identifier TEXTURE_FURNACE = new Identifier(
    "textures/gui/container/furnace.png"
  );
  public static final Identifier TEXTURE_HOPPER = new Identifier(
    "textures/gui/container/hopper.png"
  );
  public static final Identifier TEXTURE_PLAYER_INV = new Identifier(
    "textures/gui/container/hopper.png"
  );
  public static final Identifier TEXTURE_SINGLE_CHEST = new Identifier(
  ...
  public static void renderInventoryBackground(
    InventoryRenderType type,
    int x,
    int y,
    int slotsPerRow,
    int totalSlots,
    ...
    if (type == InventoryRenderType.FURNACE) {
      ...
      RenderUtils.drawTexturedRectBatched(
        x + 92,
        y + 4,
        172,
        102,
    ...
    // Most likely a Villager, or possibly a Llama
      ...
      for (int row = 0; row < rows; row++) {
        int rowLen = MathHelper.clamp(
          totalSlots - (row * slotsPerRow),
          1,
          slotsPerRow
        );
        RenderUtils.drawTexturedRectBatched(
  ...
  public static void renderInventoryBackground27(
    int x,
    int y,
  ...
  public static void renderInventoryBackground54(
    int x,
    int y,
    BufferBuilder buffer,
    MinecraftClient mc
  ...
  public static void renderEquipmentOverlayBackground(
    int x,
    int y,
    LivingEntity entity,
   ...
   * @return
   */
  public static InventoryProperties getInventoryPropsTemp(
    InventoryRenderType type,
    int totalSlots
  ) {
    ...
    if (type == InventoryRenderType.FURNACE) {
      ...
      INV_PROPS_TEMP.slotOffsetY = 8;
      int rows = (int) (
        Math.ceil((double) totalSlots / (double) INV_PROPS_TEMP.slotsPerRow)
      );
      INV_PROPS_TEMP.width =
        Math.min(INV_PROPS_TEMP.slotsPerRow, totalSlots) * 18 + 14;
  ...
  public static void renderInventoryStacks(
    InventoryRenderType type,
    Inventory inv,
    int startX,
    int startY,
    ...
    if (type == InventoryRenderType.FURNACE) {
      ...
      for (int slot = startSlot, i = 0; slot < slots && i < maxSlots;) {
        for (
          int column = 0;
          column < slotsPerRow && slot < slots && i < maxSlots;
          ++column, ++slot, ++i
        ) {
  ...
  public static void renderEquipmentStacks(
    LivingEntity entity,
    int x,
    int y,
    MinecraftClient mc
  ...
  public static void renderStackAt(
    ItemStack stack,
    float x,
    float y,
    float scale,
  ...
  public static void renderStackToolTip(
    int x,
    int y,
    ItemStack stack,
    MinecraftClient mc,
